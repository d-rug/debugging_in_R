...
-   Simulate data or provide an easily accessible small subset of your data (no csvs)
...
-   Report the bug 
    ...
    [issue](https://ucdavisdatalab.github.io/workshop_git_for_teams/opening-issues-and-making-changes.html) 
    on Github
