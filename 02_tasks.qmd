...
Repr(oducible) ex(amples), are *minimal* of code that trigger your bug and can be run by anyone, without any specialized data or software. Many times, the act of creating a reprex will help you debug your code.
